...
define([
    ...
    "MxWidget/lib/jquery-1.11.2",
    "dojo/text!MxWidget/widget/template/MxWidget.html"
    ...
    return declare("MxWidget.widget.MxWidget", [ _WidgetBase, _TemplatedMixin ], {
        ...
        postCreate: function () {
            ...
            this.nameNode.text = 'Ganesh Testing...'
...
require(["MxWidget/widget/MxWidget"]);
